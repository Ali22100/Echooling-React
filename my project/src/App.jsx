...
import "./App.css";
import Loader from "./Component/loader/Loader";// Loader component ko import kiya
...
const App = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setLoading(false); // 2 sec baad loader gayab
    }, 2000);
    ...
    <>
       ...
       <div id="div-ul">
        ...
        <div className="search-box">
          <input type="text" placeholder="Search Course" />
           <img width={20} src="https://cdn-icons-png.flaticon.com/512/10629/10629681.png" alt="" />
        </div>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <h1>
            Discover the world of<br /><span>possible university.</span>
          </h1>
          <div className="buttons">
            <a href="#" className="btn">Admissions</a>
          </div>
        </div>
      </section>
    </>
